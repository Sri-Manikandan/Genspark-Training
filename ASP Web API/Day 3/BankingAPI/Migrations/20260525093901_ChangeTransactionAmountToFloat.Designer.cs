...
namespace BankingAPI.Migrations
{
    ...
    [Migration("20260525093901_ChangeTransactionAmountToFloat")]
    partial class ChangeTransactionAmountToFloat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BankingAPI.Models.Transaction", b =>
                {
                    ...
                    b.Property<string>("to_account_number")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BankingAPI.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("BankingAPI.Models.Account", "ToAccount")
                        .WithMany()
                        .HasForeignKey("to_account_number")
                        .OnDelete(DeleteBehavior.Restrict)
